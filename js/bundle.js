...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, title, description, price, parentSelector) {
      ...
      this.classes = classes, this.parent = document.querySelector(parentSelector);
      this.transfer = 27;
    ...
    _createClass(MenuCard, [{
      ...
      value: function changeToCurrency() {
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (evt) {
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // Получаем данные из формы, превращаем их в массив с массивами, потом - в обычный объект - потом в json
  ...
  function showThanksModal(message) {
    var prevModalDilog = document.querySelector('.modal__dialog');
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  var modalButton = document.querySelectorAll(triggerSelector),
...
function slider(_ref) {
  ...
  function renderTotal() {
    if (slides.length < 10) {
      sliderTotal.textContent = "0".concat(slides.length);
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      var slideTo = e.target.getAttribute('data-id');
      slideIndex = slideTo;
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__.default)('.timer', '2021-02-29');
